    ...
    <div>
      ...
      <section className="w-full py-12 md:py-24 lg:py-32 bg-background">
        <div className="container mx-auto px-4 md:px-6">
          <h2 className="text-3xl font-bold tracking-tighter text-center md-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 max-w-6xl mx-auto">
            {features.map((feature, index) => {
              return (
                <Card
                  key={index}
                  className="border-2 hover:border-red-500 transition-colors duration-300"
                >
        ...
        <div className="container mx-auto px-4 md:px-6">
          ...
          <div className="text-center max-w-3xl mx-auto mb-12">
            ...
            <p className="text-muted-foreground">
              Four simple steps to accelerete your carrer growth
            </p>
                      ...
                      <div className="flex items-center space-x-4">
                        <div className="relative h-12 w-12 flex-shrink-0">
                          <Image
                            ...
                            className="rounded-full object-cover border-2 border-primary/205"
                          />
                        </div>
                        <div>
        ...
        <div className="mx-auto py-24 gradient rounded-lg">
          ...
          <div className="flex flex-col items-center justify-center space-y-4 text-center max-w-3xl mx-auto">
            <h2 className="text-3xl font-bold tracking-tighter text-black sm:text-4xl md:text-5xl">
              "Boost your career with expert coaching and AI tools."
            </h2> <br />
            <p className="mx-auto max-w-[600px] text-black/80 md:text-xl">
              "Be part of a community advancing with AI-powered career coaching."
            </p>
            <Link href="/dashboard">
              <Button
                size="lg"
                className="h-11 mt-5 animate-bounce bg-black text-white border border-black hover:bg-neutral-900"
              >
